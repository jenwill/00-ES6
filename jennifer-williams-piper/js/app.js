...
function displayPics(){
  ...
  // using let restricted the scope of rando to the while loop in which it was declared, so it was not available to the console.log() that is outside that while loop, and it threw a variable undefined error. Using var allowed the console.log() to access the rando variable outside the while loop.
  console.log(viewed);
